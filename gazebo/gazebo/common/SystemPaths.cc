...
SystemPaths::SystemPaths()
{
  ...
  std::string home;
  if (!homePath) {
	 // std::string tp = this->tmpPath.string();//this->TmpPath();
	  std::string tp = this->TmpPath();
	  home = tp + "/gazebo";
  }
  else {
	  home = homePath;
...
/////////////////////////////////////////////////
std::string SystemPaths::TmpPath()
{
  std::string tp = this->tmpPath.string();
  return tp;

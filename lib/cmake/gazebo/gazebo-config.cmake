...
set(GAZEBO_PLUGIN_PATH "D:/gz-ws/lib/gazebo-10/plugins")
...
set(GAZEBO_MEDIA_PATH "D:/gz-ws/share/gazebo-10/media")

# The model path contains the location on disk where models are stored.
set(GAZEBO_MODEL_PATH "D:/gz-ws/share/gazebo-10/models")
...
set(GAZEBO_PROTO_PATH
  "D:/gz-ws/include/gazebo-10/gazebo/msgs/proto")
find_library(gazebo_proto_msgs_lib gazebo_msgs
  PATHS "D:/gz-ws/lib" NO_DEFAULT_PATH)
list(APPEND GAZEBO_PROTO_LIBRARIES ${gazebo_proto_msgs_lib})
list(APPEND GAZEBO_PROTO_INCLUDE_DIRS
  "D:/gz-ws/include/gazebo-10/gazebo/msgs")
# End GAZEBO_PROTO_PATH, GAZEBO_PROTO_INCLUDE_DIRS, and
# GAZEBO_PROTO_LIBRARIES

list(APPEND GAZEBO_INCLUDE_DIRS D:/gz-ws/include)
list(APPEND GAZEBO_INCLUDE_DIRS D:/gz-ws/include/gazebo-10)

list(APPEND GAZEBO_LIBRARY_DIRS D:/gz-ws/lib)
list(APPEND GAZEBO_LIBRARY_DIRS D:/gz-ws/lib/gazebo-10/plugins)

list(APPEND GAZEBO_CFLAGS -ID:/gz-ws/include)
list(APPEND GAZEBO_CFLAGS -ID:/gz-ws/include/gazebo-10)
...
list(APPEND GAZEBO_LDFLAGS -Wl,-rpath,D:/gz-ws/lib/gazebo-10/plugins)
list(APPEND GAZEBO_LDFLAGS -LD:/gz-ws/lib)
list(APPEND GAZEBO_LDFLAGS -LD:/gz-ws/lib/gazebo-10/plugins)
